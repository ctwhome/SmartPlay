    ...
    fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            ...
            if (deniedPermissions.isEmpty()) {
                ...
                Log.w(
                        TAG,
                        "Some permissions were not granted: ${deniedPermissions.joinToString(", ")}"
                )
                Toast.makeText(
                                activity,
                                "Some features may be limited due to missing permissions",
                                Toast.LENGTH_LONG
                        )
                        .show()
        ...
        val explanations =
                deniedPermissions.mapNotNull { permission ->
                    when (permission) {
                        ...
                        Manifest.permission.BODY_SENSORS ->
                                "Body sensors permission is required to monitor your health data."
                        Manifest.permission.BLUETOOTH,
                        Manifest.permission.BLUETOOTH_ADMIN,
                        Manifest.permission.BLUETOOTH_SCAN,
                        Manifest.permission.BLUETOOTH_CONNECT ->
                        ...
                        Manifest.permission.RECORD_AUDIO ->
                                "Audio recording permission is required for voice commands."
                        Manifest.permission.ACTIVITY_RECOGNITION ->
